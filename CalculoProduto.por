programa
{
	...
	funcao capturaDados(inteiro vendas)
	{
		...
		//QUANDO COLOCA O VALOR MANUALMENTE, FUNCIONA
		inteiro Produto[vendas][3]
		inteiro contador= 0
		real quant=0.0, soma=0.0, lucro=0.0, unidade=0.0

		para(inteiro lin =0; lin < vendas; lin++)
		{
